						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									...
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a href="inscritos-exportar.php?evento=<?=$_GET["evento"];?>" target="_blank">Exportar a Excel</a></li>
										</ul>
									</div>
								</div>
								<?php
								...
								if(!empty($_GET["evento"])){
									$filtro = "WHERE epi_id_evento='".$_GET["evento"]."'";
								}
								$consulta = $conexion->query("SELECT * FROM eventos_inscripcion 
								INNER JOIN eventos ON eve_id=epi_id_evento $filtro");
								?>
